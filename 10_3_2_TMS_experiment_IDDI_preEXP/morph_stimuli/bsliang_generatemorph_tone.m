function out_data=bsliang_generatemorph_tone(tone1,tone2,perc_Rate,tone1_beg,tone2_beg,lenpa1pa2,F0_range,outmode,phon_cont_sign,tone_cont_sign)
...
%         tone_m_beg2=tone_m_pos2(1)+F0_range(1);
        ...
        minF0len=min([length(tone1.F0),length(tone_m.F0),length(tone2.F0)]);
        F0=[tone1.F0(end-minF0len+1:end);tone_m.F0(end-minF0len+1:end);tone2.F0(end-minF0len+1:end)];
    %     figure;
    %     subplot(4,2,1);
