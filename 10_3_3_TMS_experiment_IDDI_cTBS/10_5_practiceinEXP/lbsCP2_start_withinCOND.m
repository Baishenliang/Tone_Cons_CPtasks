function lbsCP2_start_withinCOND(par_code_in,session,w_subj_cond_i,turn_index)
    global is_def_range par_code par_name par_age display_instruct w_subj_cond noise_filename adjust_k Di_stimcluster Di_xaxis ses2_cond
    ...
    if bsliang_gainORDERnum(par_code)<=par_max/2
        resp_hand=1;
    else
        resp_hand=2;
    end
